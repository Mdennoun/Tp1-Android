...
public class CreatePlayerActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    genderGr.setOnCheckedChangeListener((group, checkedId) -> {
      if (checkedId == R.id.activity_create_player_radio_button_male) {
          ...
          gender ="Men";
      } else if (checkedId == R.id.activity_create_player_radio_button_female) {
  ...
  @OnClick(R.id.activity_create_player_next_btn) void onNextButtonClick() {
    ...
    bundle.putString("pseudo", pseudoEdt.getText().toString());
    bundle.putString("birthdate", birthdateEdt.getText().toString());
    bundle.putString("gendre", gender);
